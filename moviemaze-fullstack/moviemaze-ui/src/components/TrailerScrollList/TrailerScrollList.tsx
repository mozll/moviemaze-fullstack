    ...
    <>
      ...
      <div className="flex flex-col w-full max-w-full py-8">
        <div className="flex flex-row mb-6">
          ...
          <DropdownFilter
            onSelectData={(data) => {
              setMovieQuery({ ...movieQuery, mediaType: data.id.toString() });
            }}
            selectedData={movieQuery.mediaType}
            dataList={mediaTypes}
          />
        </div>
        <div className="relative">
          <div
            ...
            id={scrollListId}
          >
            <div className="absolute top-0 left-0 z-10 h-full w-14 bg-gradient-to-r from-movieDarkestDark via-movieDarkestDark to-transparent"></div>
            ...
            <TrailerList movieQuery={movieQuery} />
            <IconContext.Provider value={{ color: "white", size: "2em" }}>
              <button
            ...
            <div className="absolute top-0 right-0 z-10 h-full w-14 bg-gradient-to-l from-movieDarkestDark via-movieDarkestDark to-transparent"></div>
          </div>
        </div>
      </div>
    </>
